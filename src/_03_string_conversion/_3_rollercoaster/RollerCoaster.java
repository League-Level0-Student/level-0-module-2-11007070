...
public static void main(String[] args) {
	...
	if (heightAsInt >= 48) {
		...
		JOptionPane.showMessageDialog(null, "Hurray! You can ride the coaster with someone else!");
	}
	else {
		JOptionPane.showMessageDialog(null, "Sadly, you must be at least 42 inches tall to ride the roller coaster pal!");
	}
